...
import { Search, BookMarked, BookOpenCheck, Sparkles, UserCircle, Shield, ShieldCheck, type LucideIcon } from "lucide-react"
...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    { title: "Catalogue", url: "/catalogue", group: "Bibliothèque", icon: BookMarked },
    { title: "Emprunts", url: "/emprunts", group: "Bibliothèque", icon: BookOpenCheck },
    { title: "Recommandations", url: "/recommandations", group: "Bibliothèque", icon: Sparkles },
    { title: "Profil", url: "/profil", group: "Bibliothèque", icon: UserCircle },
    {
    ...
    { title: "Connexion", url: "/auth/sign-in", group: "Compte", icon: Shield },
    { title: "Inscription", url: "/auth/sign-up", group: "Compte", icon: Shield },
  ]
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="overflow-hidden p-0 shadow-2xl border border-zinc-200 dark:border-zinc-800 max-w-[640px]">
        ...
        >
          <CommandInput placeholder="Rechercher une page…" autoFocus />
          <CommandList>
