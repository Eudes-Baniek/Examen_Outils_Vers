import { BookOpen, Users, CalendarClock, Star } from "lucide-react"
...
const stats = [
  {
    ...
    value: "10k+",
    label: "Références",
    description: "titres indexés dans le catalogue",
  },
  {
    icon: Users,
    value: "2k+",
    label: "Lecteurs actifs",
    description: "comptes étudiants & enseignants",
  },
  {
    icon: CalendarClock,
    value: "48 h",
    label: "Délai moyen",
    description: "entre demande et confirmation de prêt",
  },
  {
    icon: Star,
    value: "4,8",
    label: "Satisfaction",
    description: "enquête annuelle usagers",
  },
]
